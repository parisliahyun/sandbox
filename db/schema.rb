...
ActiveRecord::Schema.define(:version => 20130708051757) do
  ...
  add_index "cms_revisions", ["record_type", "record_id", "created_at"], :name => "index_revisions_on_record_type_and_record_id_and_created_at"
